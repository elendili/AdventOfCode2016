...
public class Day3 {
    ...
    @Test
    public void test1() {
        List<String> list = new ArrayList<String>() {{add("3 4 5");add("5 10 25");}};
        assertEquals(1, processFirstWay(list));
        list = new ArrayList<String>() {{add("5 10 25");}};
        assertEquals(0, processFirstWay(list));
        list = new ArrayList<String>() {{add("  554  421  618");}};
        assertEquals(1, processFirstWay(list));
        list = new ArrayList<String>() {{add("  1  2  3");add("  3  2  1");add("  2  1  3");}};
        assertEquals(0, processFirstWay(list));
        list = new ArrayList<String>() {{add("  3  4  5");add("  5  6  7");add("  6  7  8");}};
